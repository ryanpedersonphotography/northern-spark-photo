...
export const images: ImageCategory = {
  ...
  nature: [
    // Selected 20 unique images with f_auto,q_auto optimization and refined alt text
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651443/nature/7Y5A9026.jpg", alt: "Tall waterfall cascading down mossy rocks in a lush forest.", orientation: "portrait" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651443/nature/_E3A3024.jpg", alt: "Vibrant sunset reflecting on a calm lake with silhouetted trees.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651442/nature/_E3A0572.jpg", alt: "Sunbeams shining through fog among tall forest trees.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651439/nature/7Y5A4905.jpg", alt: "Macro photo of sparkling water droplets on green leaves.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651438/nature/_E3A5862_1.jpg", alt: "Dramatic view of waves crashing on a rocky shoreline.", orientation: "portrait" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651437/nature/_E3A0657.jpg", alt: "Panoramic view of a snow-capped mountain range under a blue sky.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651434/nature/_E3A0536.jpg", alt: "Calm lake reflecting a colorful sunrise sky and shoreline trees.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651431/nature/7Y5A4885.jpg", alt: "Abstract close-up of intricate frost patterns on a dark surface.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651430/nature/7Y5A4907.jpg", alt: "Glistening dew drops on a delicate spider web, macro view.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651421/nature/7Y5A4880.jpg", alt: "Detailed macro view of ice crystal formations.", orientation: "portrait" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651416/nature/7Y5A4688.jpg", alt: "Ocean wave curling and breaking onto a sandy beach.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651415/nature/7Y5A4879.jpg", alt: "Sharp icicles hanging from a snow-covered tree branch.", orientation: "portrait" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651407/nature/7Y5A4872.jpg", alt: "Abstract macro photo of air bubbles frozen in ice.", orientation: "portrait" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651403/nature/7Y5A4726.jpg", alt: "Clear stream water flowing over smooth, dark rocks.", orientation: "portrait" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651391/nature/7Y5A4544.jpg", alt: "Dramatic sky reflected on wet beach sand at low tide.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651368/nature/7Y5A0913.jpg", alt: "Wide river flowing through a green valley under a blue sky.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651368/nature/_E3A2147.jpg", alt: "Vibrant pink flower with yellow center, close-up view.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651365/nature/7Y5A0753.jpg", alt: "Expansive snow-covered landscape with bare trees in winter.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651364/nature/7Y5A0668.jpg", alt: "Forest path covered in colorful fallen autumn leaves.", orientation: "landscape" },
    { src: "https://res.cloudinary.com/dtszzijrd/image/upload/f_auto,q_auto/v1743651341/nature/3E3A1828.jpg", alt: "Rolling sand dunes in a desert under a clear blue sky.", orientation: "landscape" }
  ]
};
